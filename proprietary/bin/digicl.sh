...
DIGICL_VER=`getprop ro.build.version.sdk`.5.0
...
# Block below lines, since parameter for init service is no longer available from N-OS.
#
...
# Getting BugReport is no longer available from N-OS
echo "> Retrieving BugReport or QuickDump Logs(/data/local/quickdump)..."
#cp -r /data/data/com.android.shell/files/bugreports $PATH_TARGET/bugreports
mv $PATH_EXTERNAL_STORAGE/quickdump $PATH_TARGET/quickdump
